  ...
  return (
    <main>
      ...
      <section className="collection-guide">
        <div><span>New to collecting?</span><h2>Parallel. Insert. Serial.<br /><i>Learn the language.</i></h2></div>
        <p>Plain-English guides connect terminology to cards already in the collection, so you can understand the difference without leaving the story.</p>
        <Link className="button-primary" href="/learn">Open the beginner’s guide →</Link>
      </section>
      <SiteFooter />
    </main>
  );
